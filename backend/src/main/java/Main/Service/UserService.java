...
public class UserService {
  ...
  public List<transaction> findTransactionByDateRange(
      String servicename, String startingDate, String endingDate) {
  ...
  public ResponseEntity<String> payforService(
      String servicename, String serviceProvider, double amount) {
    User user = (User) session.getAttribute("user");
    ...
    transaction payment_transaction =
        new transaction(servicename, serviceProvider, "Payment", amount);
  ...
  public ResponseEntity<String> deleteFavService(favourites reqToDelete) {
    favouriteRepository.deleteByServicenameAndCompany(
        reqToDelete.getServicename(), reqToDelete.getCompany());
    return ResponseEntity.ok("Successfully deleted");
  }
}
